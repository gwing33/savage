...
import { FanBoxPage } from "../../fan-box.tsx";
...
export default async function fanBoxController(context: any) {
  ...
  const html = await renderToString(<FanBoxPage user={user} params={params} />);
